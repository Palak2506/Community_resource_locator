...
public class FireService {
    ...
    public FireService() {}  // Empty constructor for Firebase

    public FireService(String name,String address, String vehicleCount, String email, Location location, String phone, String serviceHours) {
        this.name= name;
