...
public class On_health_admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_health_admin);
        ...
        mapView.getMap(getString(R.string.ola_map_api_key), new OlaMapCallback() {
            ...
            public void onMapReady(OlaMap map) {
                ...
                curr_location.setOnClickListener(v -> {
                    ...
                    if (currentLocation != null) {
                        ...
                        Toast.makeText(On_health_admin.this, "Unable to fetch current location", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            public void onMapError(String error) {
                Toast.makeText(On_health_admin.this, "Map Error: " + error, Toast.LENGTH_SHORT).show();
            }
        },mapControlSettings);
    }
}
