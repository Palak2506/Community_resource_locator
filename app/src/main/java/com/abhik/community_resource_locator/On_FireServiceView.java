...
public class On_FireServiceView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("MarkedServices/FireServices");
        ...
        mapView.getMap(getString(R.string.ola_map_api_key), new OlaMapCallback() {
            ...
            public void onMapError(String error) {
                Toast.makeText(On_FireServiceView.this, "Map Error: " + error, Toast.LENGTH_SHORT).show();
            }
        }, mapControlSettings);
    }
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(On_FireServiceView.this, "No location data available!", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onCancelled(DatabaseError error) {
                ...
                Toast.makeText(On_FireServiceView.this, "Failed to fetch data!", Toast.LENGTH_SHORT).show();
            }
        });
    }
